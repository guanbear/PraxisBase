    ...
    <nav class="topnav" aria-label="${escapeHtml(zh ? "知识库视图" : "Wiki views")}" data-i18n-aria-label="nav.aria">
      ...
      <div class="theme-switch" aria-label="${escapeHtml(zh ? "切换主题" : "Theme")}">
        <button type="button" data-theme-option="auto" aria-pressed="true" title="${escapeHtml(zh ? "跟随系统" : "System")}">
          <svg aria-hidden="true" viewBox="0 0 24 24"><path d="M12 3a9 9 0 1 0 9 9 4 4 0 0 1-4-4 4 4 0 0 1-4-4 9 9 0 0 0-1-1z"></path><circle cx="8" cy="8" r="1.4"></circle><path d="M8 12v.01M12 16v.01M16 11v.01"></path></svg>
        </button>
