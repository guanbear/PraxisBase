  ...
  const raw: ContextReducerRule[] = [
    {
      ...
      actions: [
        ...
        { type: "preserve_experience_fidelity", window_lines: 2, max_sections: 140 },
    ...
    },
    {
      ...
      actions: [
        { type: "strip_ansi" },
        { type: "collapse_whitespace" },
        { type: "preserve_experience_fidelity", window_lines: 1, max_sections: 100 },
        { type: "preserve_sections_matching", section_pattern: "(?:title|content|concept|file|session|score|source|id|lesson|verification|fix|error)" },
    ...
    {
      id: "claude-code-session-default",
      family: "claude-code-session",
      priority: 5,
      confidence: 0.85,
      pass_through_file_inspection: true,
      source_match: { agent: "claude-code" },
      actions: [
        { type: "strip_ansi" },
        { type: "dedupe_adjacent_lines" },
        { type: "collapse_whitespace" },
    ...
    {
      id: "opencode-session-default",
      family: "opencode-session",
      priority: 5,
      confidence: 0.85,
      pass_through_file_inspection: true,
      source_match: { agent: "opencode" },
      actions: [
        { type: "strip_ansi" },
        { type: "dedupe_adjacent_lines" },
        { type: "collapse_whitespace" },
