...
describe("runDailyExperience", () => {
  ...
  it("derives clear personal next actions from daily report counts", () => {
    const nextActions = deriveDailyNextActions({
      ...
      lessons: { enabled: false, source_items: 0, selected_spans: 0, deterministic_lessons: 0, ai_lessons: 0, active_personal: 0, wiki_ready: 0, skill_ready: 0, human_required: 0, rejected: 0, wiki_evidence: 0, ai_cache: { enabled: false, hits: 0, misses: 0, writes: 0, corrupt: 0 }, golden_validation: [] },
